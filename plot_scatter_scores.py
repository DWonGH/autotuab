...
#         {'name': 'TUAB', 'fn':'Auto Diagnosis ROC File 2021-11-30 17_04_26.npz'}] # Train
...
for k, run in enumerate(runs):
    ...
    ax[k].scatter(m_normality, m_abnormality, label="normals", alpha=0.5, linewidths=0)
    ...
    ax[k].scatter(m_normality, m_abnormality, label="abnormals", alpha=0.5, linewidths=0)

    ax[k].set_xlabel('p(normal)')
    ax[k].set_ylabel('p(abnormal)')
